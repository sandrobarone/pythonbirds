...
class FaseTestes(TestCase):
    def teste_acabou_com_porcos_e_passaros(self):
        ...
        self.assertEqual(
            VITORIA, fase.status(), "Obstáculo não interfere no fim do jogo"
        )
    ...
    def teste_status(self):
        ...
        fase.adicionar_obstaculo(Obstaculo())
        self.assertEqual(
            VITORIA, fase.status(), "Obstáculo não interfere para definir vitória"
        )
        ...
        self.assertEqual(
            VITORIA, fase.status(), "Sem porco ativo, o jogo deveria acabar com vitória"
        )
...
def criar_fase_exemplo(multiplicador=1):
    ...
    passaros = [
        PassaroVermelho(3 * multiplicador, 3 * multiplicador),
        PassaroAmarelo(3 * multiplicador, 3 * multiplicador),
        PassaroAmarelo(3 * multiplicador, 3 * multiplicador),
    ]
    porcos = [
        Porco(78 * multiplicador, multiplicador),
